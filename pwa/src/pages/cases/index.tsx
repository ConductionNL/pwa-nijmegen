      ...
      <main>
        ...
        <div className="row">
          ...
          <div className="col-6">
            ...
            {
              dossiers !== null ?
                <Table columns={[{headerName: "ID", field: "id"}, {
                  headerName: "Description",
                  field: "description"
                }, {headerName: "Start date", field: "startDate"}]} rows={dossiers}/>
                :
                <p className="utrecht-paragraph">Geen resultaten gevonden</p>
            }
          </div>
          <div className="col-4">
            <Card title={"Andere zaken"} cardBody={function (){return(<>
              Bekijk uw lopende zaken met andere overheidsinstanties op <a href="https://mijn.overheid.nl/">MijnOverheid</a>
              </>)}}/>
          </div>
        </div>
